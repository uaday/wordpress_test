<?php get_header();?>
<div id="home_default_rev_slider_wrapper" class="rev_slider_wrapper fullscreen-container"
     data-alias="focus-parallax"
    ...
    <div id="home_default" class="rev_slider fullscreenbanner" style="display:none;">
        <ul>
            <li data-index="digital_slide_1" data-transition="crossfade" data-slotamount="default"
                data-easein="default"
                data-easeout="default" data-masterspeed="500" data-rotate="0" data-saveperformance="off"
                data-title="Focus">

                <img src="images/slider_img_01.jpg" alt="images" data-lazyload="" data-bgposition="center center"
                ...
                <div class="tp-caption tp-resizeme"
                     ...
                     data-paddingbottom="[0,0,0,0]"
                     data-paddingleft="[0,0,0,0]"
                     style="z-index: 6;font-size: 85px; white-space: nowrap;text-transform:left;color: #008cb5;font-family: 'Montserrat', sans-serif;font-weight: 700;">
                    Wait
                </div>
            ...
            <li data-index="digital_slide_2" data-transition="crossfade" data-slotamount="default"
                data-easein="default"
                data-easeout="default" data-masterspeed="500" data-rotate="0" data-saveperformance="off"
                data-title="Focus">

                <img src="images/slider_img_02.jpg" alt="images" data-lazyload="" data-bgposition="center center"
                     data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg"
                     data-no-retina>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="looking_for_left para_default">
                    ...
                    <p>Lorem ipsum dolor sit amet, vix an natum labitur eleifend, mel amet a great laorit menandri.
                        Ei
                        justo complectitur duo. Ei mundi solet ut soletu mel possit quo. Sea cu justo laudem.An
                        utinam
                        consulatu eos, est facilis suscipiantur te, vim te iudico delenit voluptatibus. </p>
                    <p>Sea cu justo laudem.An utinam consulatu eos, est facilis suscipiantur te, vim te iudico
                        delenit
                        voluptatibus. Te eos accusam repudiandae.Lorem ipsum dolor sit amet, vix an natum labitur
                        eleifend, mel amet a great laorit menandri. Ei justo complectitur duo. Ei mundi solet ut
                        soletu
                        mel possit quo. </p>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="choose_us_single para_default image_fulwidth text-center wow fadeInLeft"
                     data-wow-delay="300ms">
                    <img src="images/why_choos_us_01.jpg" alt="images">
                    <h3>Consultancy services</h3>
                    <p>Lorem ipsum dolor sit amet, elit. Donec nec ornare purus. Nulla non augue ut mi mollis eget
                        id
                        arcu. Rem autem voluptatem</p>
                </div>
            </div><!--col-md-4 -->
